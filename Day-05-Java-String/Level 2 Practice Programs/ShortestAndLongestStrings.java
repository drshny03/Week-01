...
//Program to split text into words and find shortest and longest strings
class ShortestAndLongestStrings{
	...
	public static String[] findShortestLongest(String[][] wordsWithLengths){
		//variable to store shortest and longest strings length
		int shortest = Integer.MAX_VALUE;
		int longest = Integer.MIN_VALUE;
		
		//array to store shortest and longest strings
		String[] shortestAndLongestArray = new String[2];
		
		//loop to find longest and shortest strings length
		for(int i=0; i<wordsWithLengths.length; i++){
			//get length of word and convert it into integer
			int lengthOfWord = Integer.parseInt(wordsWithLengths[i][1]);
			//find longest strings
			if(lengthOfWord < shortest){
				shortest = lengthOfWord;
				shortestAndLongestArray[0] = wordsWithLengths[i][0];
			}
			//find longest strings
			if(lengthOfWord > longest){
				longest = lengthOfWord;
				shortestAndLongestArray[1] = wordsWithLengths[i][0];
			}
		}
		//return resultant array
		return shortestAndLongestArray;
	}
			
    //method to display results
	public static void displayResult(String[][] wordsWithLengths, String[] shortAndLong){
		//println 2d array
		...
		//print shortest and longest array
		System.out.println("Shortest string " + shortAndLong[0] + "\nLongest string " + shortAndLong[1]);
	}
    // main method
    public static void main(String[] args) {
        ...
        //Get shortest and longest strings
		String[] shortAndLong = findShortestLongest(wordsWithLengths);
		
        // Display the results
        displayResult(wordsWithLengths, shortAndLong);
